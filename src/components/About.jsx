        ...
        <div>
            <Main>
                ...
                <FirstSection>
                    ...
                    <FirstSectionpara>
                        <h3><span style={{fontSize:"40px",fontWeight:"bolder"}}>I</span>nterglobal Insurance Company, an independent insurance agency located in Medley, FL is committed to the principles of service, integrity and professionalism while providing our valued clients the highest quality of service with the goal of exceeding their expectations. Financial security and protection for our clients’ commitment as well as fairness and empowerment to our agents. Respect and opportunity for our employees, increasing value and reward for our shareholders.</h3>
                    </FirstSectionpara>
                </FirstSection><br/><br/>
                <FirstSection>
                    <FirstSectionpara>
...
margin-top:100px;
`
const FirstSection=style.div`
display:flex;
justify-content: space-between;
`
const FirstSectionpara=style.div`
margin:0 5% 0 10%;
display:flex;
align-items:center;
`
const FirstSectionPhoto=style.div`
margin:0 10% 0 5%;
display:flex;
align-items:center;
`